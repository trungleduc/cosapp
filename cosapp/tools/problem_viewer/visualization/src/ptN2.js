...
function PtN2Diagram(parentDiv, modelData) {
    ...
    function PrintConnects() {
        ...
        for (var key in newConnsDict) {
            ...
            text += "<br />" + paramName + " can be connected to " + unknownName;
        }
    ...
    var n2BackgroundRect = n2Group.append("rect")
        ...
        .on("mousemove", function () {
            ...
            if (newConnsDict[r + "_" + c] === undefined) {
                ...
                if({{draw_potential_connections}}) {
                    parentDiv.querySelector("#connectionId").innerHTML += "<br /><i style=\"color:red;\">" + paramName + " can be connected to " + unknownName + "</i>";
                }
            }
        });
