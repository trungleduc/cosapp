...
Have a look a the `introduction <https://cosapp.readthedocs.io/docs/tutorials/00-Introduction.html#>`_.

This code is the property of Safran SA. It uses code coming from various open-source projects. See `LICENSE <https://gitlab.com/cosapp/cosapp/master/LICENSE.rst>`_ file.
